  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = ADC3_IN9_5VIN_Pin|GPIO_PIN_4|GPIO_PIN_5|ADC3_IN4_VINLAMP2_Pin
                          |ADC3_IN5_BINLAMP_Pin|ADC3_IN6_STOPLAMP_Pin|ADC3_IN7_RIGHTSIGNAL_Pin|ADC3_IN8_LEFTSIGNAL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, ADC_IN4_BRAKE_Pin|ADC1_IN5_ANGLETEST_Pin|ADC1_IN6_GAS_Pin|ADC1_IN7_RIGHTARM_AXIS_Y_Pin);

    HAL_GPIO_DeInit(GPIOC, ADC1_IN14_LEFTARM_AXIS_X_Pin|ADC1_IN15_LEFTARM_AXIS_Y_Pin);

    HAL_GPIO_DeInit(ADC1_IN9_RIGHTARM_AXIS_X_GPIO_Port, ADC1_IN9_RIGHTARM_AXIS_X_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOF, ADC3_IN9_5VIN_Pin|GPIO_PIN_4|GPIO_PIN_5|ADC3_IN4_VINLAMP2_Pin
                          |ADC3_IN5_BINLAMP_Pin|ADC3_IN6_STOPLAMP_Pin|ADC3_IN7_RIGHTSIGNAL_Pin|ADC3_IN8_LEFTSIGNAL_Pin);

    HAL_GPIO_DeInit(GPIOC, ADC3_IN10_12VIN_Pin|ADC3_IN11_VMCU_Pin|ADC3_IN12_3V3IN_Pin|ADC3_IN13_M0_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC3_IN1_FRONT_LIGHT_CURRENT_Pin|ADC3_IN2_BACK_LIGHT_CURRENT_Pin|ADC3_IN3_VINLAMP1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(DYH_UART4_TX_GPIO0_GPIO_Port, DYH_UART4_TX_GPIO0_Pin);

    HAL_GPIO_DeInit(DYH_UART4_RX_GPIO1_GPIO_Port, DYH_UART4_RX_GPIO1_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(DEBUG_UART5_TX_GPIO_Port, DEBUG_UART5_TX_Pin);

    HAL_GPIO_DeInit(DEBUG_UART5_RX_GPIO_Port, DEBUG_UART5_RX_Pin);
